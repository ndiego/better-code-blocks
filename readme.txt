=== Better Code Blocks ===
Contributors: ndiego
Tags: code, syntax highlighting, blocks, gutenberg, editor
...
Enhanced code block functionality for WordPress with syntax highlighting, line numbers, and copy functionality.
